<?php
require $_SERVER['DOCUMENT_ROOT'].'/evote/data/RandomInfo.php';
require $_SERVER['DOCUMENT_ROOT'].'/evote/data/Dialogue.php';
$dialogue = new dialogue();

$startup = true;
$filename = $_SERVER['DOCUMENT_ROOT'].'/evote/data/config.php';
